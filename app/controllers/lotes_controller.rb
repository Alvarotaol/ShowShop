class LotesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @lote.save
        format.html { redirect_to @lote, notice: 'O lote foi criado com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @lote.update(lote_params)
        format.html { redirect_to @lote, notice: 'O lote foi atualizado com sucesso.' }
  ...
  def destroy
    @lote.destroy
    respond_to do |format|
      format.html { redirect_to lotes_url, notice: 'O lote foi removido com sucesso.' }
